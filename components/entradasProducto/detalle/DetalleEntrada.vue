<template>
  <v-container class="mt-2">
    ...
    <v-row>
      <v-col>
        <tabla-productos-detalle class="mt-2"
          :items="items"
          :loading="loading"
        />
      </v-col>
...
import TablaProductosDetalle from "@/components/entradasProducto/detalle/TablaProductosDetalle";
...
export default {
  ...
  components:{
    'tabla-productos-detalle':TablaProductosDetalle,
  },
  async created(){
